namespace FluentIL.Emitters
{
        ...
        : IEmitter
    {
        ...
        public IEmitter EmitWriteLine(FieldInfo fld)
        {
            ...
            MethodInfo method = typeof(Console).GetTypeInfo().GetMethod("get_Out");
            this.Call(method);
            ...
            MethodInfo method2 = typeof(TextWriter).GetTypeInfo().GetMethod("WriteLine", new[] { fld.FieldType });
            if (method2 == null)
            {
                throw new ArgumentException("Argument_EmitWriteLineType", "fld");
            }
            
            this.CallVirt(method2);
            return this;
        }
        ...
        public IEmitter EmitWriteLine(string value)
        {
            ...
            this.LdStr(value);
            MethodInfo method = typeof(Console).GetTypeInfo().GetMethod("WriteLine", new Type[] { typeof(string) });
            this.Call(method);
            return this;
        }
        ...
        {
            this.debugOutput.WriteLineColor(ConsoleColor.DarkYellow, "-----EmitWriteLine-Start----");
            ...
            MethodInfo method2 = typeof(TextWriter).GetTypeInfo().GetMethod("WriteLine", array);
            if (method2 == null)
            {
            ...
            this.CallVirt(method2);
            this.debugOutput.WriteLineColor(ConsoleColor.DarkYellow, "-----EmitWriteLine-End-----");
            return this;
        }
        ...
        private void OutputILOffset()
        {
            ...
            this.offset = this.emitter.ILOffset; 
        }
